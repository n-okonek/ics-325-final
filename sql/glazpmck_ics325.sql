...
INSERT INTO `city` VALUES (6,'Kangerlussuaq','Some people enjoy a destination where safety and history meet. ',15,35,'GL'),(7,'Qeqertarsuatsiaat','If you like a small-town getaway feel with treasure hunts and whales, then this is the location for you!',15,35,'GL'),(8,'Bad Kissingen','I know what you may be thinking… does the name of this region really speak for the millions of kissers that live there? It’s possible, but situations have not been reported. ',35,50,'DE'),(9,'Berlin','Love history? This place is loaded with it! Berlin allows you to partake in rebuilding the wall and knocking it down so that travelers from all over the world can experience the history first hand!',35,50,'DE'),(10,'Alice Springs','This location is geared more towards spring breakers. Australia is known for hot and hip culture.',76,82.5,'AU'),(11,'Kazumba','Love to learn about other cultures, this place has three major tribes and nine collectives. ',60,53,'AF'),(12,'Los Angeles','Los Angeles is a water-park of dreams! Every year floods provide entertainment beyond your wildest dreams!',45,16,'US'),(13,'Mwanza','Africa has so many things to offer. Mwanza is practically off the grid, but be warned... this travel destination isn’t for the weak.',60,53,'AF'),(14,'Samburg','This location is home of the gas production. This travel spot is more for the volunteer / mission type folk.',25,70,'RU'),(15,'San Diego','San Diego could be considered one of the most naturally artistic cities in north America, and is especially interesting to the thrill seekers.',45,16,'US'),(16,'Snezhngorsk','This location is a closed city. You know what this means! It means that like spy movies, and other video games... the main goal is to infiltrate and become one with this city.',25,70,'RU'),(17,'Yulara','This small town in Australia is like a giant fancy hotel with amenities available to house you while you explore outside the town.',76,82.5,'AU');
...
-- Dump completed on 2020-04-14 16:38:50
